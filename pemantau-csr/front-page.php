    ...
    <div class="container">
        ...
        <div class="row mb-5">
            <div class="col-12 text-center">
                <h2 class="section-title text-white mb-3">Visi & Misi Kami</h2>
        ...
        <div class="row align-items-stretch">
                ...
                <div class="visi-misi-card visi-card h-100">
                    ...
                    <div class="card-body">
                        <p class="card-content">
                            Menjadi organisasi CSR terdepan yang menciptakan dampak positif berkelanjutan bagi masyarakat dan lingkungan
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="visi-misi-card misi-card h-100">
                    ...
                    <div class="card-body">
                        <ul class="misi-list">
                            <li><span class="bullet"></span> Memfasilitasi program CSR yang berdampak nyata bagi masyarakat</li>
                            <li><span class="bullet"></span> Mengembangkan kemitraan strategis dengan berbagai stakeholder</li>
                            <li><span class="bullet"></span> Meningkatkan kesadaran perusahaan tentang tanggung jawab sosial</li>
                            <li><span class="bullet"></span> Mendorong inovasi dalam program-program keberlanjutan</li>
                            <li><span class="bullet"></span> Membangun ekosistem CSR yang kolaboratif dan transparan</li>
                        </ul>
                    </div>
                </div>
            </div>
